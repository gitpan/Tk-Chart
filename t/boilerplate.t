...
TODO: {
  ...
  module_boilerplate_ok('lib/Tk/Chart.pm');
  module_boilerplate_ok('lib/Tk/Chart/Areas.pm');
  module_boilerplate_ok('lib/Tk/Chart/Bars.pm');
  module_boilerplate_ok('lib/Tk/Chart/Boxplots.pm');
